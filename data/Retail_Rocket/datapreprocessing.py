'''
This code is utilized to create the kg.txt file.
'''
...
trn_view = pickle.load(open(predir+'./data/Retail_Rocket/trn_view','rb'))
trn_cart = pickle.load(open(predir+'./data/Retail_Rocket/trn_cart','rb'))
trn_buy = pickle.load(open(predir+'./data/Retail_Rocket/trn_buy','rb'))
...
tst_int = pickle.load(open(predir+'./data/Retail_Rocket/tst_int','rb'))
test_x, test_y = [], []
