...
class MetaConvTranspose2d(RCAEModule):
    def __init__(self, *args, **kwargs):
        super().__init__()
...
class MetaBatchNorm2d(RCAEModule):
    def __init__(self, *args, **kwargs):
        super().__init__()
